...
##### Read and merge data ####
#####------------------------------------------------------#
setwd("~/Documents/College/2022/Fall/GOV1347/R-Projects/ElectionAnalytics/content/post/2022-09-22-blog-post-3-polling")
popvote_df <- read_csv("inc_pop_vote_df.csv") # update here
economy_df <- read_csv("RDI_quarterly.csv") # update here
