...
#      main="histogram of true Y - predicted Y")
```
residual distribution being skewed indicates it is not a good model.
...
```
A better fitted model would have a smaller range
